...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'text-white-primary border-dark flex h-8.5 w-full items-center justify-between rounded-md border bg-transparent p-3 text-sm',
      'placeholder:text-muted focus:outline-none focus-visible:outline-none',
  ...
  (
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        align={align}
        className={cn(
          'text-white-primary bg-bg-secondary border-dark relative z-50 overflow-hidden rounded-md border p-1 shadow-md',
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:text-white-primary focus:bg-dark',
